    ...
    pressed(false)
{
    ...
    this->aboutUs->setText("<style>a{text-decoration: none;}</style><a href=\"http://caomai.ssdut153.cn/index.html\">  关于我们");
    ...
    this->regButton->setGeometry(306, 108, 70, 32);
    this->headSculp->setGeometry(23, 108, 74, 74);
    this->aboutUs->setGeometry(313, 150, 70, 32);
